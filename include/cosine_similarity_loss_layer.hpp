 ...
 * input to a CosineSimilarityLossLayer exactly formulates a linear least squares
...
class CosineSimilarityLossLayer : public LossLayer<Dtype> {
 public:
  explicit CosineSimilarityLossLayer(const LayerParameter& param)
      : LossLayer<Dtype>(param){}
  virtual void Reshape(const vector<Blob<Dtype>*>& bottom,
      const vector<Blob<Dtype>*>& top);

  virtual inline const char* type() const { return "CosineSimilarityLoss"; }
  /**
   * Unlike most loss layers, in the CosineSimilarityLossLayer we can backpropagate
 ...
 protected:
  /// @copydoc CosineSimilarityLossLayer
   ...
   *
   * Unlike other children of LossLayer, CosineSimilarityLossLayer \b can compute
