#ifndef CAFFE_MultiStageMeanfieldAU3_LAYER_HPP_
#define CAFFE_MultiStageMeanfieldAU3_LAYER_HPP_
...
namespace caffe {
	...
	class MultiStageMeanfieldAU3Layer : public Layer<Dtype> {

	public:
		explicit MultiStageMeanfieldAU3Layer(const LayerParameter& param) : Layer<Dtype>(param) {}
	...
	protected:
		...
		virtual void compute_bilateral_kernel(const Blob<Dtype>* const rgb_blob, const int feature_dim, const int n, float* const output_kernel);
...
#endif  // CAFFE_MultiStageMeanfieldAU3_LAYER_HPP_
